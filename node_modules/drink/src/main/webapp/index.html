...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body ng-app="drinkApp">
        ...
        <script src="scripts/app/entities/location/location.js"></script>
        <script src="scripts/app/entities/location/location.controller.js"></script>
        <script src="scripts/app/entities/location/location-detail.controller.js"></script>
        <script src="scripts/components/entities/location/location.service.js"></script>
        <script src="scripts/app/entities/track/track.js"></script>
        <script src="scripts/app/entities/track/track.controller.js"></script>
        <script src="scripts/app/entities/track/track-detail.controller.js"></script>
        <script src="scripts/components/entities/track/track.service.js"></script>
        <!-- endbuild -->
</body>
</html>
