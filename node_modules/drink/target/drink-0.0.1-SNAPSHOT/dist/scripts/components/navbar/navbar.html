            ...
            <ul class="nav navbar-nav nav-pills navbar-right">
                ...
                <li ui-sref-active="active" ng-switch-when="true" class="dropdown pointer">
                    ...
                    <ul class="dropdown-menu">
                        <li ui-sref-active="active" ><a ui-sref="location"><span class="glyphicon glyphicon-asterisk"></span>
                        &#xA0;<span translate="global.menu.entities.location">location</span></a></li>
                        <li ui-sref-active="active" ><a ui-sref="track"><span class="glyphicon glyphicon-asterisk"></span>
                        &#xA0;<span translate="global.menu.entities.track">track</span></a></li>
